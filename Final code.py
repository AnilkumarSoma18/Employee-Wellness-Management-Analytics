  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "C_mqRDEmObbW",
        "outputId": "43fbb17a-f4f8-46cf-8e22-14860f6bf0cb"
      },
      "outputs": [
        {
          "output_type": "stream",
          "name": "stdout",
          "text": [
            "\u001b[?25l     \u001b[90m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m \u001b[32m0.0/981.5 kB\u001b[0m \u001b[31m?\u001b[0m eta \u001b[36m-:--:--\u001b[0m\r\u001b[2K     \u001b[91m━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[91m╸\u001b[0m\u001b[90m━━━━━━━━━━━\u001b[0m \u001b[32m696.3/981.5 kB\u001b[0m \u001b[31m21.6 MB/s\u001b[0m eta \u001b[36m0:00:01\u001b[0m\r\u001b[2K     \u001b[90m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m \u001b[32m981.5/981.5 kB\u001b[0m \u001b[31m11.3 MB/s\u001b[0m eta \u001b[36m0:00:00\u001b[0m\n",
            "\u001b[?25h  Preparing metadata (setup.py) ... \u001b[?25l\u001b[?25hdone\n",
            "\u001b[2K   \u001b[90m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m \u001b[32m10.5/10.5 MB\u001b[0m \u001b[31m71.0 MB/s\u001b[0m eta \u001b[36m0:00:00\u001b[0m\n",
            "\u001b[2K   \u001b[90m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m \u001b[32m4.3/4.3 MB\u001b[0m \u001b[31m45.8 MB/s\u001b[0m eta \u001b[36m0:00:00\u001b[0m\n",
            "\u001b[2K   \u001b[90m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m \u001b[32m278.2/278.2 kB\u001b[0m \u001b[31m8.0 MB/s\u001b[0m eta \u001b[36m0:00:00\u001b[0m\n",
            "\u001b[2K   \u001b[90m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m \u001b[32m44.8/44.8 kB\u001b[0m \u001b[31m1.7 MB/s\u001b[0m eta \u001b[36m0:00:00\u001b[0m\n",
            "\u001b[2K   \u001b[90m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m \u001b[32m608.4/608.4 kB\u001b[0m \u001b[31m22.6 MB/s\u001b[0m eta \u001b[36m0:00:00\u001b[0m\n",
            ...
            "\u001b[2K   \u001b[90m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m \u001b[32m11.4/11.4 MB\u001b[0m \u001b[31m53.7 MB/s\u001b[0m eta \u001b[36m0:00:00\u001b[0m\n",
    ...
    },
    {
      "cell_type": "markdown",
      "source": [
        "ep-sparkling-bread-aznufzdt-pooler.c-3.ap-southeast-1.aws.neon.tech"
      ],
      "metadata": {
        "id": "XOpyIYvNJTJE"
      }
    },
    {
      ...
      "metadata": {
        ...
        "id": "fSpJ1BdmObbX",
        "outputId": "f65fa91c-42fe-4401-e269-65f79af1f56a"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "hmm-KbaFgobK",
        "outputId": "f9778d75-c664-4600-da66-59312c6641ae"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "E1bJzYPvyHV3",
        "outputId": "3f23c564-7fff-4e8d-aa7b-6c7694a87127"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "07d41b9b-ad1d-41dd-e3ce-d25d49e7bd25"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "024afcc8-e8f6-48ea-a636-473adf16a397"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "d3bb7d2e-a30a-43ea-f64b-4b5761a66524"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "c7aa1c46-214f-41d5-d0c4-41b1c02b5d2d"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "3ba3d683-3969-476e-ca38-471b958aa773"
      },
      "outputs": [
        {
          "output_type": "stream",
      ...
      "source": [
        ...
        "    text = _EMOJI_RE.sub(\"\", str(label)).strip()\n",
        "    for canonical in MOOD_STYLE:\n",
        "        if text.lower() == canonical.lower():\n",
        "            return canonical\n",
        "    return text\n",
        "\n",
        "def _dedupe_counts(data: dict) -> dict:\n",
        "    merged = {}\n",
        ...
        "    wedges, _texts = ax.pie(values, colors=colors, startangle=90, wedgeprops=dict(width=0.38, edgecolor=\"white\"))\n",
        "    ax.set(aspect=\"equal\")\n",
        "    legend_labels = [f\"{style_for(l)['emoji']} {l}\" for l in labels]\n",
        "    ax.legend(wedges, legend_labels, loc=\"center left\", bbox_to_anchor=(1.05, 0.5),\n",
        "              frameon=False, fontsize=9, labelcolor=\"#544E72\")\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "16e7566d-e7b8-4630-e3ea-c051b55fd24d"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "ec335414-980e-4206-88b9-5bbd5913e73e"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "429dded4-956e-4f81-887f-ec7069812ea7"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "93cf3b48-7b5c-4998-a931-5e7d63932d42"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "f101789b-0aea-407c-cc1a-ffc60ca41567"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "5138b263-57b6-49eb-caab-72a88a996ae9"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "2ab5255d-905d-4070-de34-c054f1343219"
      },
      "execution_count": 16,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "44d59dbf-2073-4ac1-b541-1c3dcc573ab7"
      },
      "execution_count": 17,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "d0215990-5264-485c-bdbd-9b9455f04580"
      },
      "execution_count": 18,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "c7dec98b-09d1-4d77-c7e6-cef0dd05ef35"
      },
      "execution_count": 19,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "cee9f57e-16d9-4f18-f139-8e111d2bf903"
      },
      "execution_count": 20,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "60d2f844-c4d1-4aef-9d1d-c4bd35d0c62d"
      },
      "execution_count": 21,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "7cf3abce-defc-462d-f9b2-952bfd111de1"
      },
      "execution_count": 23,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "ad9dd1a4-9a58-4588-9e6c-601b856b0d47"
      },
      "execution_count": 24,
      "outputs": [
        {
